...
public class Headquarters extends Robot {
    ...
    static void runHeadquarters(RobotController rc, int turnCount) throws GameActionException {
        ...
        if (currRobotCount > 20*hqCount && rc.canBuildRobot(RobotType.AMPLIFIER, newLoc) && turnCount % 50 == 0 && turnCount >= 350) {
            rc.buildRobot(RobotType.AMPLIFIER, newLoc);
        }
        if (currRobotCount > 20*hqCount && rc.canBuildAnchor(Anchor.STANDARD) && rc.getNumAnchors(Anchor.STANDARD) < 1) {
